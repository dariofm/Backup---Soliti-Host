...
begin
  if messagebox(frmPrincipal.Handle,'Confirmar saída do Sistema?','Sair',mb_yesno+MB_ICONQUESTION)= idno then
  begin
    Abort
  end
    else
...
begin
  ...
  try
    try
      ...
      ShowMessage('Sistema não encontrado, fazer a configuração manualmente.');
    end;
  end;
